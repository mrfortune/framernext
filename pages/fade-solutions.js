          ...
          <Grid container mt={6} spacing={0} sx={{ maxWidth: "md" }}>
            <Grid item xs={12} md={12} lg={12} mb={8}>
              ...
              <Typography variant="body1">
                ...
                discover and buy products directly from the video on the
                platform they are on, without redirects.
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} lg={12} md={12} mb={8}>
              ...
              <Typography variant="body1">
                ...
                to user info, nor could we interview users since their users are
                their business clients.
              </Typography>

              <Typography variant="body1">
                Fade did part of our Double Diamond work for us and we just
                needed to build on what they provided and begin with competitive
                and comparative analysis then moved to sketches and low-fidelity
            ...
            <Grid item xs={12} lg={12} mb={8}>
              ...
              <Typography variant="body1">
                ...
                consumers, so we focused heavily on their layout and UI
                components including analytics. Fade has no direct competitors
                based on their unique offering.
              </Typography>
              <Typography variant="body2">Observations:</Typography>
              <Box component="ul" className="ulStyle">
                <li>
                  Dashboards all have analytics and charts and features to
                  analyse the data.
                </li>
                <li>
            ...
            <Grid item xs={12} lg={12} md={12} mb={8}>
              ...
              <Typography variant="body1">
                ...
                competitor. We next looked at Amazon's Seller Central's
                dashboard. Their business model is not an advertishing based
                model but there are similarities in their solutions. This was to
                gather more data on how these solutions are designed, and to get
                more inspiration.
              </Typography>
            </Grid>
            <Grid item xs={12} lg={12} md={12} mb={8}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} mb={8}>
              ...
              <Typography variant="body1">
                A simple and intuitive dashboard with all of the minimal
                features that Fade needs for its clients. These are the final
            ...
            <Typography variant="h5">Testing</Typography>
              ...
              <Typography variant="body1">
                ...
                with our clients to identify problems in our prototype, uncover
                opportunities and to discover users' behaviors and preferences.
                We worked from user testing scripts and guided our users to
                perform specific tasks. We conducted our sessions via Zoom and
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} mb={8}>
              ...
              <Typography variant="body1">
                ...
                experience for those components. In this particualr project we
                had to rely on the brief which gave us a lot of information to
                begin designing our solution and we were then able to validate
